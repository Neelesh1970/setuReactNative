...
const AgricultureHomeScreen = ({ navigation }) => {
  ...
  const knowledgeItems = [
    ...
    },
    {
      ...
      subtitle: 'Learn sustainable practices for healthier crops and environment.',
                ...
                <View style={styles.knowledgeText}>
                  ...
                  {item.isExpert && (
                    <TouchableOpacity style={styles.expertButton}>
                      <Text style={styles.expertButtonText}>Talk to Experts</Text>
                    </TouchableOpacity>
                  )}
                </View>
...
const styles = StyleSheet.create({
  ...
  bannerText: { fontSize: 24, fontWeight: '700', color: 'black', marginBottom: 12 },
  bookButton: { 
  ...
  sectionTitle: { fontSize: 18, fontWeight: '600', marginHorizontal: 16, marginVertical: 8, color: '#333' },
  ...
  tabsContainer: { flexDirection: 'row', marginHorizontal: 16, marginVertical: 8 },
  tabButton: { flex: 1, paddingVertical: 8, borderBottomWidth: 2, borderBottomColor: 'transparent', alignItems: 'center' },
  tabButtonActive: { borderBottomColor: '#2e7d32' },
  tabText: { fontSize: 14, color: '#666' },
  tabTextActive: { color: '#2e7d32', fontWeight: '600' },

  knowledgeList: { paddingHorizontal: 16 },
  knowledgeItem: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  knowledgeText: { flex: 1, paddingRight: 8 },
  knowledgeTitle: { fontSize: 16, fontWeight: '600', marginBottom: 4 },
  knowledgeSubtitle: { fontSize: 14, color: '#666', marginBottom: 8 },
  knowledgeImage: { width: 80, height: 60, borderRadius: 6 },
  expertButton: { backgroundColor: '#2e7d32', paddingVertical: 6, paddingHorizontal: 12, borderRadius: 4, alignSelf: 'flex-start' },
